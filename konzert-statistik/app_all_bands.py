...
def _api_request(user_id: str) -> list[dict]:
    page = 1
...
with_covers = col1.checkbox(
    "Mit Cover-Songs",
    value=True,
    help="Zähle Cover-Songs",
)
with_special = col2.checkbox(
    "Mit Variationen",
    help="Zähle Variationen als separate Songs",
)
...
if user_name:
    with st.spinner("Loading..."):
        songs, concerts = get_data(
            user_name, with_special=with_special, with_covers=with_covers
        )
